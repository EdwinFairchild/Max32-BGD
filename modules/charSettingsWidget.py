...
"")
        ...
        self.lbl_char_name = QtWidgets.QLabel(self.widgetCharSettings)
        self.lbl_char_name.setGeometry(QtCore.QRect(400, 0, 151, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lbl_char_name.setFont(font)
        self.lbl_char_name.setStyleSheet("text-align: center;\n"
"padding-left: 0px;\n"
"border-radius:5px;\n"
"border: 0px solid gray;\n"
